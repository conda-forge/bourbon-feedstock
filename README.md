...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bourbon-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3748&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bourbon-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bourbon` can be installed with:

```
conda install bourbon
```

It is possible to list all of the versions of `bourbon` available on your platform with:
